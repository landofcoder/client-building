...
start "git clone desktop %TAG_DESKTOP%" /B /wait git clone %GIT_CLONE_DEPTH% --branch=%TAG_DESKTOP% https://github.com/landofcoder/nextcloud-desktop %PROJECT_PATH%/desktop
if %ERRORLEVEL% neq 0 goto onError
